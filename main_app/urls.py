...
urlpatterns = [
    ...
    path('characters/<int:character_id>/associate-power/<int:power_id>', views.associate_power, name='associate-power'),
    path('characters/<int:character_id>/unassociate-power/<int:power_id>', views.unassociate_power, name='unassociate-power'),
